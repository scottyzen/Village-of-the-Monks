<template>
  <div class="absolute z-50 w-full py-8">
    <div class="container flex items-end justify-between">
      ...
      <!-- Desktop Menu -->
      <nav
        class="hidden font-medium leading-tight tracking-tight text-gray-900 md:flex"
      >
        <NuxtLink to="/brandonhill">Brandon Hill</NuxtLink>
        <NuxtLink to="/duiskeabbey">Duiske Abbey</NuxtLink>
        <NuxtLink to="/tinnahinchcastle">Tinnahinch Castle</NuxtLink>
        <NuxtLink to="/riverbarrow">River Barrow</NuxtLink>
      </nav>
        ...
        <div v-if="mobileMenuIsOpen" class="fixed top-0 left-0 w-full p-6">
          ...
          >
            ...
            <div @click="mobileMenuIsOpen = false" class="flex flex-col">
              ...
              <NuxtLink class="p-2" to="/brandonhill">Brandon Hill</NuxtLink>
              <NuxtLink class="p-2" to="/duiskeabbey">Duiske Abbey</NuxtLink>
              <NuxtLink class="p-2" to="/tinnahinchcastle"
                >Tinnahinch Castle</NuxtLink
              >
              <NuxtLink class="p-2" to="/riverbarrow">River Barrow</NuxtLink>
            </div>
          </div>
        </div>
      </transition>
