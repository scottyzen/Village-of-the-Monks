...
// 				if (numberOfImagesAdded >= this.numberOfImages || i >= shuffedInstaAPI.length - 1) {
...
// 						animation: `move ${minMax(40, 85)}s ease-out infinite ${minMax(0, 2000)}ms`,
// 						size: minMax(100, 200),
// 						top: minMax(10, 80),
...
// 	},
// 	beforeMount() {
// 		axios.get(`https://www.instagram.com/explore/tags/${this.hashtag}/?__a=1`).then((res) => {
